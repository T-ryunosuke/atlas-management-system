...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
            ['over_name' => '徳長','under_name' => '龍之介','over_name_kana' => 'トクナガ','under_name_kana' => 'リュウノスケ', 'mail_address' => Str::random(6).'@gmail.com', 'sex' => '1', 'birth_day' => '1999-02-08', 'role' => '4', 'password' => Hash::make('password')],
